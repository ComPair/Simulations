...
void PlotBackground(){
	...
	TFile *f = new TFile("HadronicBackground/HadronicBackground.R2.spectrum.root");
	TCanvas * C = (TCanvas*)f->Get("c1");
	TH1D * h_had = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("LeptonicBackground/LeptonicBackground.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
	TH1D * h_lep = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("PhotonicBackground/PhotonicBackground.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
	TH1D * h_pho = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("TrappedHadronicBackground/TrappedHadronicBackground.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
	TH1D * h_thad = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("TrappedLeptonicBackground/TrappedLeptonicBackground.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
	TH1D * h_tlep = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("HadronicActivation/HadronicBackground.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
	TH1D * h_had_decay = (TH1D*)C->GetPrimitive("EnergySpectrum");

	f = new TFile("TrappedHadronicActivation/TrappedHadronicBackgroundDecay.R2.spectrum.root");
	C = (TCanvas*)f->Get("c1");
